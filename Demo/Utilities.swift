...
/// Make a perspective projection transform in right hand coordination.
...
func deg2rad(_ degrees: Float) -> Float {
    return (degrees / 180) * .pi
}

func rad2deg(_ radius: Float) -> Float {
